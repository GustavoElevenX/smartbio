...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title: project?.name || "Experiência", description: project?.description || "Uma experiência guiada criada com SmartBio.", robots: project ? { index: true, follow: true } : { index: false, follow: false }, openGraph: { title: project?.name || "SmartBio", description: project?.description || "Seu melhor próximo passo." } };
}
