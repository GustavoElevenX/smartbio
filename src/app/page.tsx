      ...
      <div className="container-shell relative grid items-center gap-16 lg:grid-cols-[1.08fr_.92fr]">
        <div className="max-w-[670px]">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link href="/app/onboarding" className="focus-ring inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-[#17171c] px-6 font-bold text-white shadow-[0_16px_40px_rgba(23,23,28,.18)] transition hover:-translate-y-0.5">Criar minha experiência <ArrowRight size={18} /></Link>
