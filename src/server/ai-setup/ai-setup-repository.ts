...
function sessionToRow(session: AISetupSession, actor: AISetupActor) {
  return {
    ...
    commercial_architecture: session.commercialArchitecture || null,
    architecture_reviewed: session.architectureReviewed || false,
    architecture_edited: session.architectureEdited || false,
