...
export const presenceSectionRegistry: Record<PresenceSectionType, { label: string; description: string; defaultContent: Record<string, unknown> }> = {
  hero: { label: "Abertura", description: "Apresentação principal e ações", defaultContent: { variant: "split", badges: [], alignment: "left" } },
  ...
  logo_cloud: { label: "Marcas", description: "Clientes e parceiros", defaultContent: { assetIds: [] } },
  ...
  testimonials: { label: "Avaliações", description: "Provas sociais confirmadas", defaultContent: { layout: "cards", items: [] } },
  faq: { label: "Dúvidas frequentes", description: "Perguntas frequentes", defaultContent: { items: [] } },
  ...
  conversion_cta: { label: "Chamada final", description: "Conecta conteúdo à jornada", defaultContent: { primaryAction: { type: "start_conversion_goal", label: "Começar", conversionGoalId: "defina-uma-meta", style: "primary" } } },
